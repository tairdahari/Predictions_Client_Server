package clientSubComponents.results.executionList;
...
public class ExecutionListRefresher extends TimerTask {
    ...
    public ExecutionListRefresher(String userName, Consumer<DTOListSimulationDetails> dtoListSimulationDetailsConsumer, String id) {
